...
cp /storage/brno3-cerit/home/vlkofly/mockingbird_genomics/fastq_vcf_workshop/mapping/p2m1m2result/TBG_06ta*final.ba* $SCRATCHDIR
cd $SCRATCHDIR
echo data loaded at `date`

java -XX:ParallelGCThreads=2 -Xmx16g -jar $GATK/GenomeAnalysisTK.jar -T HaplotypeCaller -I TBG_06ta_final.bam --min_base_quality_score 20 --min_mapping_quality_score 20 -rf BadMate -R JIC_reference/alygenomes.fasta -o TBG_06ta_HC.g.vcf.gz -ploidy 4 -stand_call_conf 20 -ERC GVCF --pcr_indel_model NONE -nct 2 --max_num_PL_values 350 
echo calling done at `date`

rm -r JIC_reference/alygenomes.fasta
rm TBG_06ta*final.ba* 
